...
export function Usuario({ userName, userPhoto, onSavePhoto, onRemovePhoto, onSignOut, darkMode, onSetTheme }) {
  ...
  return (
    <div className={styles.screen}>
      <div className={styles.content}>
        ...
        <h2 className={styles.pageTitle}>Listinha</h2>
        ...
        <div className={styles.avatarSection}>
          ...
          >
            {userPhoto ? (
              <img src={userPhoto} alt="Foto de perfil" className={styles.avatarImg} />
            ) : (
          ...
          <div className={styles.avatarEditBadge} onClick={() => fileInputRef.current?.click()} role="button" tabIndex={0} aria-label="Editar foto">
        ...
        {/* Agradecimento */}
        <p className={styles.thanks}>Obrigado por usar meu app!</p>
        <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" className={styles.heart} aria-hidden="true">
